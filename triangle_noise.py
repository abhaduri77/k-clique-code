# -*- coding: utf-8 -*-
"""
Created on Sat May  8 21:36:26 2021
...
#for the edge (v3,g2)(v2,g3)
my_provider = IBMQ.get_provider()
device = my_provider.get_backend(name='ibmq_16_melbourne')
...
for key in noisy_final.keys():
    freq_key = key[0:6]
    result_freqs[freq_key] = result_freqs[freq_key] +noisy_final[key] 
    D = result_freqs
